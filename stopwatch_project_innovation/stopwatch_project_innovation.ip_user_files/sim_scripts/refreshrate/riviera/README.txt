...
#
# Generated by export_simulation on Thu Mar 28 20:16:03 -0400 2019
#
################################################################################
...
switch to the './refreshrate.sh' script.

./refreshrate.sh -reset_run
...
./refreshrate.sh -noclean_files

For more information on the script, please type './refreshrate.sh -help'.
