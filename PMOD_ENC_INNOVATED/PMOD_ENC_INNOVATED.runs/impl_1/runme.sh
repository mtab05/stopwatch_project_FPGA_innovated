...
HD_PWD='W:/Desktop/PmodENC_Source/project_test_pmodenc/project_test_pmodenc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodENC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodENC.tcl -notrace
