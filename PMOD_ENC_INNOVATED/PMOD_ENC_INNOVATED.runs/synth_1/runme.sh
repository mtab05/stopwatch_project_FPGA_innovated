...
HD_PWD='W:/Desktop/PmodENC_Source/project_test_pmodenc/project_test_pmodenc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodENC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodENC.tcl
